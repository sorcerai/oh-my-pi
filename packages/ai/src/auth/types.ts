 ...
 * The rows are internal state used to refresh the in-memory credential pool.
 */
...
/**
 * Public result for {@link CredentialsApi.insertIfProviderAbsent}.
...
export interface CredentialsApi {
	 ...
	 * Requires the store's atomic create-only capability; a read-then-write
	...
	/** Atomically insert every absent provider in a credential batch; present providers are skipped. */
