...
async function generateModels() {
	...
	// Seed Claude Code's subscription-backed aliases and pinned ids. The SDK
	// discovery is runtime-scoped, so these zero-cost local rows remain the
	// synchronous fallback and dynamic rows are additive.
