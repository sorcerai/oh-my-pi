 ...
 *   runtime stays paused until an explicit reset
 ...
 * `undefined` means the `tools` field was omitted and selects the default subset;
 * an explicit list that filters down to no known tools remains `[]`.
 */
