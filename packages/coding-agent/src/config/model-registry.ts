...
import type { ApiKeyResolver, FetchImpl, LocalAuthRef, ResolvedApiKey, UsageProvider } from "@oh-my-pi/pi-ai";
...
export class ModelRegistry {
	...
	getAvailableForProviders(providers: ReadonlySet<string>, kind: ModelKind | "all" = "chat"): Model<Api>[] {
		...
		const models = this.#composeStaticModels(availableProviders).filter(isAuthRefAvailable);
