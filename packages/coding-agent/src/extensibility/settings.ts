...
export const cfgSkillsPromptMode = register({
	id: "skills.promptMode",
	type: "enum",
...
export const cfgSkillsPromptSkills = register({
	id: "skills.promptSkills",
	type: "array",
	default: EMPTY_STRING_ARRAY,
});
...
export const cfgSkills = combine({
	...
	promptMode: cfgSkillsPromptMode,
	promptSkills: cfgSkillsPromptSkills,
});
