...
export async function buildSystemPrompt(options: BuildSystemPromptOptions = {}): Promise<BuildSystemPromptResult> {
	...
	// Skill selection owns the prompt-mode filter, read-tool gate, and hidden-skill drop.
	const filteredSkills = selectSkillsForPrompt(skills, inventoryToolNames.includes("read"), skillsSettings);
